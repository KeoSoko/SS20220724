...
- [Workspace seat capacity](workspace-seat-capacity.md) — capacity = owner plan maxSeats (fallback 1); never auto-evict, block growth when over capacity; one-click upgrade via stored Paystack auth.
