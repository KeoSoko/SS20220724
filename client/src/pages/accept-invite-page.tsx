...
import { Loader2, CheckCircle, XCircle, Users, Shield, Eye, Edit, CreditCard } from "lucide-react";
          ...
          {!loading && !success && inviteDetails && (
            <div className="space-y-5">
              ...
              <p className="text-xs text-center text-gray-400">
                By accepting, you'll join this billing group. Your own data stays private to you.
              </p>
            </div>
          )}
        </CardContent>
