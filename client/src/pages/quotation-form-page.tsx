    ...
    apiRequest("POST", "/api/quotations", quotationData)
      .then((result: any) => {
        ...
        if (result && result.id) {
          ...
          toast({
            title: "Error",
            description: "Failed to get quotation ID for email preview",
            variant: "destructive",
          });
        }
      })
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-amber-700 text-sm mb-3">
                    Set up your business profile to include your company details, logo, and banking information on quotations.
                  </p>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <div className="flex gap-2">
                          ...
                          <Link href="/clients">
                            <Button type="button" variant="outline" size="icon" title="Add new client" data-testid="button-add-new-client">
