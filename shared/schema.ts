...
export const EXPENSE_SUBCATEGORIES: Record<typeof EXPENSE_CATEGORIES[number], string[]> = {
  "groceries": ["pick_n_pay", "woolworths", "checkers", "spar", "shoprite", "food_lover", "makro"],
  "dining": ["restaurants", "takeaway", "delivery", "fast_food", "coffee_shops", "steers", "kfc", "nandos"],
  "transportation": ["petrol", "diesel", "uber", "bolt", "taxi", "bus", "train", "parking", "tolls", "e_tolls"],
  "telecommunications": ["vodacom", "mtn", "cell_c", "telkom", "rain", "internet", "data", "airtime"],
  "utilities": ["electricity", "eskom", "water", "gas", "load_shedding_backup"],
  "municipal_services": ["rates", "refuse", "sewerage", "property_taxes", "municipal_water"],
  "rent": ["apartment", "house", "office", "storage", "parking_space"],
  "healthcare": ["medical_aid", "discovery", "momentum", "bonitas", "doctor", "dentist", "medication", "private_hospital"],
  "insurance": ["car_insurance", "home_insurance", "life_insurance", "funeral_cover", "santam", "outsurance", "old_mutual"],
  "banking_fees": ["bank_charges", "atm_fees", "card_fees", "overdraft", "fnb", "standard_bank", "absa", "nedbank"],
  "automotive": ["car_service", "tyres", "parts", "registration", "license_renewal", "roadworthy", "car_wash"],
  "domestic_services": ["cleaning", "gardening", "security", "domestic_worker", "pool_service"],
  "entertainment": ["movies", "dstv", "netflix", "showmax", "concerts", "sports", "games", "hobbies"],
  "travel": ["flights", "hotels", "car_rental", "vacation", "accommodation", "activities"],
  "education": ["school_fees", "university", "books", "stationery", "courses", "tuition"],
  "shopping": ["clothing", "electronics", "furniture", "home_goods", "game_stores", "makro", "builders"],
  "personal_care": ["salon", "barber", "skincare", "cosmetics", "spa", "gym", "virgin_active"],
  "gifts": ["birthday", "christmas", "wedding", "donations", "charity", "church_offering"],
  "other": ["miscellaneous", "professional_fees", "legal", "accounting", "subscriptions", "membership"]
};
